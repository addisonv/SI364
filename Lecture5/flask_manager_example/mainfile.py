...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/shelldb_example" # TODO: May need to change this, Windows users. Everyone will need to have created a db with exactly this name.
